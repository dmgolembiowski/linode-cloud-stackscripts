# linode/budibase-one-click.sh by linode
# id: 1037036
# description: Budibase One Click App
# defined fields: name-bbport-label-budibase-port-example-default-80-default-80
# images: ['linode/debian11', 'linode/ubuntu22.04']
# stats: Used By: 17 + AllTime: 91
#!/bin/bash
