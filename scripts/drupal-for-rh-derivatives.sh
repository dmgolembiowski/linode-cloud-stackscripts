# linode/drupal-for-rh-derivatives.sh by henszey
# id: 167
# description: 
...
# images: ['linode/centos5.632bit', 'linode/centos5.6']
# stats: Used By: 0 + AllTime: 59
#!/bin/bash                                                                        
...
function prepare_hudson {
    ...
    sed -i "s/=8080/=8081/" /etc/default/hudson
