# linode/jetbackup-one-click.sh by linode
# id: 869623
# description: JetBackup One-Click
# defined fields: name-controlpanel-label-choose-a-control-panel-to-use-with-jetbackup-5-cpanelwhm-or-linux-no-control-panel-default-cpanelwhm-oneof-cpanelwhmlinux-name-releasetier-label-choose-a-jetbackup-release-tier-default-stable-oneof-stablebetaedge
# images: ['linode/almalinux8', 'linode/centos7']
# stats: Used By: 1 + AllTime: 79
#!/bin/bash
