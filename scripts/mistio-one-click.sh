# linode/mistio-one-click.sh by linode
# id: 691614
# description: Mist.io One-Click
# defined fields: name-mist_email-label-mist-admin-users-email-example-set-your-admin-users-email-name-mist_password-label-mist-admin-users-password-example-set-your-admin-users-password
# images: ['linode/debian10']
# stats: Used By: 2 + AllTime: 201
#!/bin/bash
