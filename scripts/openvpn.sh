# linode/openvpn.sh by aminek
# id: 640933
# description: OpenVPN automated on StackScripts - your on VPN is a couple of clicks away!

Once Deployed download client.ovpn file and use with  OpenVPN client  on any machine
# defined fields: 
# images: ['linode/centos8', 'linode/debian10']
# stats: Used By: 7 + AllTime: 103
#!/bin/bash
#
