# linode/owncast.sh by gabek
# id: 780643
# description: Install Owncast, the self-hosted live video and chat server.  This will include Caddy for use as a SSL proxy. https://owncast.online
# defined fields: name-server_hostname-label-your-public-hostname-for-your-owncast-server-required-for-sslhttps-example-owncastexamplecom-default-name-email_address-label-your-email-address-required-for-sslhttps-example-meexamplecom-default
# images: ['linode/debian10', 'linode/debian11']
# stats: Used By: 9 + AllTime: 103
#!/usr/bin/bash
