# linode/simplex-chat-server.sh by npoberezkin
# id: 837009
# description: 
# defined fields: name-enable_store_log-label-store-log-persists-smp-queues-to-append-only-log-and-restores-them-upon-server-restart-default-on-oneof-on-off-name-api_token-label-linode-api-token-enables-stackscript-to-create-tags-containing-smp-server-domainip-address-transport-key-hash-and-server-version-use-domainhash-or-iphash-as-smp-server-address-in-the-client-note-minimal-permissions-token-should-have-are-readwrite-access-to-linodes-to-update-linode-tags-you-need-them-and-domains-to-add-a-record-for-the-chosen-3rd-level-domain-default-name-fqdn-label-fqdn-fully-qualified-domain-name-provide-third-level-domain-name-ex-smpexamplecom-if-provided-can-be-used-instead-of-ip-address-default
