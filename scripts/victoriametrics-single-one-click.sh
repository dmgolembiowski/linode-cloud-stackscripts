# linode/victoriametrics-single-one-click.sh by linode
# id: 954759
# description: VictoriaMetrics Single
# defined fields: name-hostname-label-hostname
# images: ['linode/ubuntu20.04']
# stats: Used By: 3 + AllTime: 18
#!/bin/bash
