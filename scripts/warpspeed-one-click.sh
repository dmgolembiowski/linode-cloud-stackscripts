# linode/warpspeed-one-click.sh by linode
# id: 923037
# description: WarpSpeed One-Click
# defined fields: name-wirespeed_admin_email-label-admin-email-default-example-itexamplecom-name-wirespeed_admin_password-label-admin-password-default-example-password-name-wirespeed_http_host-label-dns-name-default-example-vpnexamplecom-name-wirespeed_data_dir-label-data-directory-default-wirespeed-example-wirespeed
# images: ['linode/ubuntu20.04']
# stats: Used By: 15 + AllTime: 403
#!/bin/bash
set -o errexit
set -o nounset
set -o pipefail
