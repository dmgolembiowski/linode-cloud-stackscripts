# linode/wordpress-on-debian-9.sh by hmorris
# id: 116528
# description: 
# defined fields: name-ssuser-label-new-user-example-username-name-sspassword-label-new-user-password-example-password-name-hostname-label-hostname-example-examplehost-name-website-label-website-example-examplecom-name-db_password-label-mysql-root-password-name-dbuser-label-mysql-username-name-dbuser_password-label-mysql-user-password
# images: ['linode/debian9', 'linode/ubuntu16.04lts']
# stats: Used By: 5 + AllTime: 93
#!/bin/bash 
##
